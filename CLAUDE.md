...
>
> **Primary persona drivers:** Disponent (Fleet Manager), ECM Manager, Dispatcher, ECM 4 Technician, Teil-Projektleitung Telematik. The conductor is a brain persona, not a landside persona.
>
> **Primary input for next UX iteration:** `ÖBB Telematics Project Management UX - Google Gemini.pdf` — introduces the Teil-Projektleitung Telematik persona, the 3-zone control board pattern, Action Intent Objects, and the 10 landside use cases that drive the Telematics surfaces.
